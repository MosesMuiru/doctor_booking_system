  ...
  return (
    <div className=' mx-auto flex items-start justify-center text-center w-1/2 flex-col gap-10'>
        ...
        <div className='flex flex-col items-start w-full gap-5'>
            <Link href={`booking/student`} className={`border  border-main_green text-main_green  px-[3rem] py-[1.1rem] rounded-md w-full`} >Am a Student</Link>
            <Link href={'booking/outsider'} className={`border border-main_green text-main_green  px-[3rem] py-[1.1rem] rounded-md w-full`}>Am a Outside Resident</Link>
        </div>
